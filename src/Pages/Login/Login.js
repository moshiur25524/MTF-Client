                    ...
                    <div class="mt-12">
                        <form onSubmit={handleLogin}>
                            <div>
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" name='email' type="email" placeholder="mike@gmail.com" required/>
                            </div>
                            <div class="mt-8">
                            ...
                            <div class="mt-10">
                                <input class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                shadow-lg" type='submit' value='LOGIN'/>
