            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-12">
                    <form onSubmit={handleRegister}>
                        <div>
                            <div class="text-sm font-bold text-gray-700">Full Name</div>
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" name='name' placeholder="Enter Your Name" required/>
                        </div>
                        <div>
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Email Address</div>
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" name='email' placeholder="mike@gmail.com" required/>
                        </div>
                        <div class="mt-8">
                        ...
                        <div class="mt-10">
                            <input type='submit' class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                            font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                            shadow-lg" value='SIGN UP'/>
                        </div>
                    </form>
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Already have an account ? <Link to='/login' class="cursor-pointer text-indigo-600 hover:text-indigo-800">Login</Link>
                    </div>
                </div>
            </div>
        </div>
