                        ...
                        <div className="mt-12">
                            <form onSubmit={handleRegister}>
                                ...
                                <div className="mt-8">
                                    ...
                                    <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" name='password' type="password" placeholder="Enter your password" />
                                </div>
                                <div className="mt-10">
                                    {errorMessage}
